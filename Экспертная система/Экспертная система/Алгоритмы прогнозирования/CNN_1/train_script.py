...
model = Sequential()         
model.add(Conv1D(window_size,h3INT("NN_sctruct","layer1","kernel_size"),activation='relu', input_shape=(window_size,dataset.shape[1])))
model.add(Conv1D(window_size,h3INT("NN_sctruct","layer2","kernel_size"),activation='relu'))
model.add(MaxPooling1D(pool_size=h3INT("NN_sctruct","layer3","MaxPooling1D")))
model.add(Conv1D(h3INT("NN_sctruct","layer4","neurons_count"),h3INT("NN_sctruct","layer4","kernel_size"), activation='relu'))
