try:
    ...
    continue_ = ''
    python_obj = json.loads('''{"person":{"firstName":"Антон","age":"21","friends":{"person":{"firstName":"Сергей","age":"26"},"person(2)":{"firstName":"Ксения","age":"18","friends":{"person":{"firstName":"Павел","age":"24"},"person(2)":{"firstName":"Карина","age":"21"}}},"person(3)":{"firstName":"Анна","age":"24"},"person(4)":{"firstName":"Александр","age":"21"}},"date":{"day":"24","month":"november","year":"2018"},"":{"day":"24"}}}''')
    #print(json.dumps(python_obj["person"]["friends"]["person(2)"]["friends"]["firstName"],indent=15,ensure_ascii=False))
    print(python_obj['person']['friends']['person(2)']['firstName'])
    parser = createParser()
