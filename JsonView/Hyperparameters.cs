...
namespace JsonView
{
    ...
    public class Hyperparameters
    {
        ...
        {
            int rowHeigh = fontDepth * 2;
            draw(rootId, target_pictureBox, form1, fontDepth, columnWidth, rowHeigh);
        }
        public void draw(int rootId, PictureBox target_pictureBox, Form1 form1, int fontDepth, int columnWidth, int rowHeigh)
        {
        ...
        {
            picBox.Image = bitmap;
            form1.Invoke(new Action(() => { form1.Refresh(); }));
        }
